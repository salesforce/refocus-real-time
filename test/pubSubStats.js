...
describe('test/pubSubStats.js >', () => {
  ...
  describe('end-to-end >', () => {
    ...
    const updRe = /info: activity=pubsub key=refocus.internal.realtime.sample.update process=d1:0 subCount=4 subTime=\d+ emitCount=4 emitTime=\d+ clientCount=4 clientTime=\d+ \n/;
    const addRe = /info: activity=pubsub key=refocus.internal.realtime.sample.add process=d1:0 subCount=2 subTime=\d+ emitCount=2 emitTime=\d+ clientCount=2 clientTime=\d+ \n/;
    const delRe = /info: activity=pubsub key=refocus.internal.realtime.sample.delete process=d1:0 subCount=1 subTime=\d+ emitCount=1 emitTime=\d+ clientCount=1 clientTime=\d+ \n/;
